...
namespace Forkage\NovaBelongsToDepend\Http\Controllers;
...
class FieldController extends \Orlyapps\NovaBelongsToDepend\Http\Controllers\FieldController
{
        ...
        return collect($fields)->map(function ($field) {
            ...
            if (isset($field->fields)) {
                if ($field->fields instanceof Collection) {
                    $field->fields = $field->fields->toArray();
                }
